...
const AdvantageData =
   {
       costPerRank: MapDefault.makeFromArray([['Beyond Mortal', 50], ['Let There Be', 40], ['Luck of the Gods', 5], ['Lucky', 5], ['Omnipresent', 5], ['Omniscient', 5], ['Sidekick', 2], ['Stay Like That', 15], ['Variable Modifier', 35], ['Your Petty Rules Don\'t Apply to Me', 50]], 1),
       defaultText: MapDefault.makeFromArray([['Favored Environment', 'Environment'], ['Favored Foe', 'Foe type'], ['Languages', 'Languages Known'], ['Minion', 'Helper Name'], ['Sidekick', 'Helper Name'], ['Stay Like That', 'Power Modified'], ['Supreme', 'Power Gained']], 'Advantage Subtype'),
       godhoodNames: ['Beyond Mortal', 'Let There Be', 'Luck of the Gods', 'Omnipresent', 'Omniscient', 'Perfect Focus', 'Stay Like That', 'Supreme', 'Variable Modifier', 'Your Petty Rules Don\'t Apply to Me'],
       mapThese: ['Close Attack', 'Defensive Roll', 'Improved Critical', 'Improved Initiative', 'Ranged Attack', 'Seize Initiative'],
       maxRanks: MapDefault.makeFromArray([['Attractive', 2], ['Benefit', Infinity], ['Close Attack', Infinity], ['Daze', 2], ['Defensive Roll', Infinity], ['Equipment', Infinity], ['Evasion', 2], ['Fascinate', Infinity], ['Improved Critical', 4], ['Improved Initiative', 5], ['Improvised Weapon', Infinity], ['Inspire', 5], ['Languages', Infinity], ['Luck', Infinity], ['Lucky', 3], ['Minion', Infinity], ['Omnipresent', 3], ['Omniscient', 5], ['Precise Attack', 4], ['Ranged Attack', Infinity], ['Second Chance', Infinity], ['Set-up', Infinity], ['Sidekick', Infinity], ['Supreme', Infinity], ['Takedown', 2], ['Throwing Mastery', Infinity]], 1)
...
function changeData()
{
   ...
   if (Main !== undefined && Main.isOldRules())  //this does not execute during the constructor of Main because old rules are false by default
   {
       ...
       AdvantageData.names = commonAdvantageNames.concat(['Agile Feint', 'Animal Empathy', 'Artificer', 'Assessment', 'Chokehold', 'Close Attack', 'Contacts', 'Daze', 'Eidetic Memory', 'Fascinate', 'Favored Environment', 'Favored Foe', 'Fearless', 'Grabbing Finesse', 'Great Endurance', 'Hide in Plain Sight', 'Improved Smash', 'Improvised Weapon', 'Inventor', 'Leadership', 'Luck', 'Precise Attack', 'Ranged Attack', 'Redirect', 'Ritualist', 'Second Chance', 'Set-up', 'Startle', 'Takedown', 'Taunt', 'Throwing Mastery', 'Tracking', 'Uncanny Dodge', 'Weapon Bind', 'Weapon Break', 'Well-informed']).sort();
   ...
   else
   {
       ...
       PowerData.names = commonPowerNames.concat(['Attain Knowledge', 'Mental Transform', 'Mind Switch', 'Permeate', 'Phantom Ranks', 'Resistance', 'Summon Minion', 'Summon Object']).sort();
       ...
       var newFlawNames = commonModifierFlawNames.concat(['Ammunition', 'Fragile', 'System Dependent', 'Uncontrollable Entirely', 'Uncontrollable Result', 'Uncontrollable Target']).sort();
