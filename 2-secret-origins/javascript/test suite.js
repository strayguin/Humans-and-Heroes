...
Tester.abilityList.calculateValues=function(isFirst)
{
   ...
   //test missing non stamina
    actionTaken='Set Missing Awareness'; TesterUtility.changeValue('Awareness', '--');
    testResults.push({Expected: true, Actual: Main.abilitySection.getByName('Awareness').isMissing(), Action: actionTaken, Description: 'Awareness is missing'});
   ...
   //test missing stamina in new rules
    actionTaken='Set Missing Stamina'; TesterUtility.changeValue('Stamina', '--');
